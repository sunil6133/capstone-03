    ...
    <Grid container spacing={gridSpacing}>
        ...
        <SubCard title="Primary Color">
          <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="primary.dark" data={{ label: 'Blue-50', color: '#E3F2FD' }} title="primary.dark" dark />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
      ...
      <Grid item xs={12}>
        <SubCard title="Secondary Color">
          <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="secondary.dark" data={{ label: 'DeepPurple-50', color: '#ede7f6' }} title="secondary.dark" dark />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
      ...
      <Grid item xs={12}>
        <SubCard title="Success Color">
          <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="success.dark" data={{ label: 'Green-A100', color: '#b9f6ca' }} title="success.dark" dark />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
      ...
      <Grid item xs={12}>
        <SubCard title="Orange Color">
          <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="orange.dark" data={{ label: 'DeepOrange-50', color: '#fbe9e7' }} title="orange.dark" dark />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
      ...
      <Grid item xs={12}>
        <SubCard title="Error Color">
          <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="error.dark" data={{ label: 'Red-50', color: '#ef9a9a' }} title="error.dark" dark />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
      ...
      <Grid item xs={12}>
        <SubCard title="Warning Color">
          <Grid container spacing={gridSpacing}>
            <Grid item xs={12} sm={6} md={4} lg={2}>
              <ColorBox bgcolor="warning.dark" data={{ label: 'Amber-50', color: '#b9f6ca' }} title="warning.dark" dark />
            </Grid>
            <Grid item xs={12} sm={6} md={4} lg={2}>
